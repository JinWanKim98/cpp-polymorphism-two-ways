...
// Constructor: Initialize square with vertices
...
// Compute area of square using bounding box
...
// Check if point is strictly inside the square (not on perimeter)
...
// Generate string representation of square
